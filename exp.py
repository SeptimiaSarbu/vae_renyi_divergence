...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_layers', '-l', type=int, choices=[1, 2], default=2)
    ...
    if args.dimH > 0:
        hidden_layers = [[args.dimH for i in range(args.num_layers)]]
    else:
        hidden_layers = [[]]
    ...
    iter_each_round = 1
    num_rounds = int(args.iter / iter_each_round)
